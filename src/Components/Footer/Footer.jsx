        ...
        <div className='grid grid-cols-1 md:grid-cols-2 mt-14 '>
            ...
            <div>
                ...
                <div className='grid grid-cols-2 text-slate-400'>
                   <p className='mt-2 flex items-center gap-2'><FaLocationArrow className='text-white'></FaLocationArrow>Hanoi</p>
                   <p className='mt-2 flex items-center gap-2'><FaLocationArrow className='text-white'></FaLocationArrow>Dhaka</p>
                   <p className='mt-2 flex items-center gap-2'><FaLocationArrow className='text-white'></FaLocationArrow>Florida</p>
                   <p className='mt-2 flex items-center gap-2'><FaLocationArrow className='text-white'></FaLocationArrow>Dohar</p>
                   <p className='mt-2 flex items-center gap-2'><FaLocationArrow className='text-white'></FaLocationArrow>Lahore</p>
                   <p className='mt-2 flex items-center gap-2'><FaLocationArrow className='text-white'></FaLocationArrow>California</p>
                </div>
            </div>
            </div>
        </div>
